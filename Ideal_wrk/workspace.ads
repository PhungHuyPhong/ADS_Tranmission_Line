<ADSWorkspace Revision="13" Version="100">
    <Workspace Name="">
        ...
        <Library Name="NLSCT_lib" />
        <Dataset Name="NLSCT.ds" />
        <Log Name="netlist.log" />
        <Log Name="search_history.log" />
        <Preferences Name="layout.prf" />
        <Preferences Name="NLSCT_lib_lay.prf" />
        <Preferences Name="schematic.prf" />
        <LibraryDefs Name="lib.defs" />
        <ConfigFile Name="dds.cfg" />
        <ConfigFile Name="de_sim.cfg" />
        <ConfigFile Name="hpeesofsim.cfg" />
        <Dataset Name="IdealQuarterWave.ds" />
        <Dataset Name="SA_QuarterWaveMatch1_IdealQuarterWave.ds" />
        <Dataset Name="DA_SmithChartMatch1_IdealQuarterWave.ds" />
        <Cell Name="NLSCT_lib:QuarterWave" />
        <Data_Display Name="QuarterWave.dds" />
        <Cell Name="NLSCT_lib:ParallelStub" />
    </Workspace>
</ADSWorkspace>
