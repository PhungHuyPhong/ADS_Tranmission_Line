<ADSWorkspace Revision="3" Version="100">
    <Workspace Name="">
        ...
        <Library Name="MicroStripline_lib" />
        <Cell Name="MicroStripline_lib:ParallelStub" />
        <Cell Name="MicroStripline_lib:QuarterWave" />
        <Data_Display Name="QuarterWave.dds" />
        <Dataset Name="QuarterWave.ds" />
        <Log Name="netlist.log" />
        <Log Name="search_history.log" />
        <Preferences Name="ads_builtin_lay.prf" />
        <Preferences Name="layout.prf" />
        <Preferences Name="MicroStripline_lib_lay.prf" />
        <Preferences Name="MicroStripline_lib_sch.prf" />
        <Preferences Name="schematic.prf" />
        <Substrate Name="MicroStripline_lib:tech.subst" />
        <LibraryDefs Name="lib.defs" />
        <ConfigFile Name="dds.cfg" />
        <ConfigFile Name="de_sim.cfg" />
        <ConfigFile Name="hpeesofsim.cfg" />
        <Dataset Name="ParallelStub.ds" />
        <Data_Display Name="ParallelStub.dds" />
    </Workspace>
</ADSWorkspace>
